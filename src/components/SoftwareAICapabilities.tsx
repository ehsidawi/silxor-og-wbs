...
const SoftwareAICapabilities = () => {
  ...
  const capabilities = [
    ...
    { icon: Brain, title: t("Sovereign AI Deployment", "نشر الذكاء الاصطناعي السيادي"), description: t("Private LLM hosting on IR4Q infrastructure. No data leaves sovereign control.", "استضافة نماذج لغوية خاصة على بنية IR4Q. لا تخرج بيانات من السيطرة السيادية."), technical: "LLMs • RAG • Vector Search • Air-gap", layer: t("BUILD", "بناء"), coord: t("36.2°N · 44.0°E", "٣٦.٢° ش · ٤٤.٠° شر") },
