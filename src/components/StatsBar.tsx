          ...
          {stats.map((stat, index) => (
            <div key={index} className="flex items-center">
              <div className="flex flex-col items-center text-center group cursor-default" style={{ minWidth: 100 }}>
                <span className="font-mono font-[700] transition-colors duration-200 group-hover:text-sovereign-gold" style={{ fontSize: 28, color: "#F0EDE8" }}>
                  {stat.value}
                </span>
                <span className="font-body font-[400] uppercase" style={{ fontSize: 11, letterSpacing: "0.1em", color: "#8A8F9E", marginTop: 6 }}>
                  {stat.label}
                </span>
              </div>
