...
const Services = () => {
  ...
  const capabilities = [
    ...
    { icon: Database, title: t("Data Residency & Compliance", "إقامة البيانات والامتثال"), description: t("Regulatory compliance across Iraqi and international frameworks.", "الامتثال التنظيمي عبر الأطر العراقية والدولية."), technical: "GDPR • <30s RTO • RPO: 15min", coord: t("33.3°N · 44.4°E", "٣٣.٣° ش · ٤٤.٤° شر") },
    { icon: Wrench, title: t("Managed Operations", "العمليات المدارة"), description: t("24/7 Iraqi-based NOC with U.S. engineering escalation.", "مركز عمليات عراقي مع تصعيد لفرق هندسية أمريكية."), technical: "Baghdad NOC • <15min P1", coord: t("33.3°N · 44.4°E", "٣٣.٣° ش · ٤٤.٤° شر") },
