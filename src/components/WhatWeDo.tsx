...
const WhatWeDo = () => {
  ...
  const units = [
    ...
    },
    {
      ...
      body: t(
        "Private large language model deployments, agentic AI workflows, RAG pipelines, and intelligent process automation — all hosted sovereignly. Your AI, your data, your control.",
        "نشر نماذج لغوية خاصة، سير عمل ذكاء اصطناعي، خطوط أنابيب RAG، وأتمتة عمليات ذكية — مستضافة سيادياً. ذكاؤك الاصطناعي، بياناتك، سيطرتك."
      ),
    },
    {
      icon: ShieldCheck,
